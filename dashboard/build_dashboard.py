...
<li><b>A coordinated fleet.</b> Six TSLAX wallets form a creation chain, each seeded ~500 USDT by the last in near-constant ~4.5 USDT steps. Three SPYX wallets run identical parameters; two wallets wash SPYX in both its pools.</li>
...
<section><h2>The coordination: a fleet built from one funding chain</h2><div class="sub">The TSLAX fleet as a creation chain: each wallet created and seeded by the last, seeds falling in near-constant ~4.5 USDT steps.</div><div class="figure"><img src="data:image/png;base64,{fig['funding.png']}" alt="funding chain"></div></section>
